...
// busca na tabela hash um cliente, retornando um booleano verdadeiro se houver
// o cliente, ou falso se o cliente não existir.
...
// função da tabela hash, que realiza a função mod a partir do número imei e de
// uma chave hash inserida.
int Hash::getHash(Cliente cliente) { return cliente.getImei() % max_items; }